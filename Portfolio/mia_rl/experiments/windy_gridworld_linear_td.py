...
def run_windy_gridworld_linear_td():

    args = parse_args()
    
    output_dir = Path(__file__).resolve().parents[1] / "outputs" / "windy_gridworld_linear_td"
    ...
    plot_td_errors(output_dir, algorithm, td_error_curve, title="LinearTD0: mean |TD error| per episode")
